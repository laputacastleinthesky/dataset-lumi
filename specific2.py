...
# File paths
TEXT_DIR = r"D:\data5\text"
AUDIO_DIR = r"D:\data5\audio"
JSON_DIR = r"D:\data5\json"
EXCEL_PATH = r"D:\data5\files_list.xlsx"
...
# Parameters
START_NUM = 148  # Start task number
TOTAL_FILES = 1  # Number of files to generate
...
voices = [
    ...
    "zh-CN-YunxiaNeural", "zh-CN-YunyangNeural", "zh-CN-XiaoxuanNeural"
]
...
for i in range(TOTAL_FILES):
    ...
    # 生成txt内容（包含两个物品和两个数量）
    text = f"请在2025年{month}月{date}日{time_idx}将{quantity1}个{item1},{quantity2}个{item2}{action_idx}{loc_idx}点位"
    texts.append(text)
...
def generate_json(task_id, quantity1, quantity2, item1, item2, target, action_idx, task_type, month, date, time_idx):
    time_mapping = {
