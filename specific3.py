...
# File paths
TEXT_DIR = r"D:\data4\text"
AUDIO_DIR = r"D:\data4\audio"
JSON_DIR = r"D:\data4\json"
EXCEL_PATH = r"D:\data4\files_list.xlsx"
...
# Parameters
START_NUM = 201  # Start task number
TOTAL_FILES = 97  # Number of files to generate
...
for i in range(TOTAL_FILES):
    ...
    # 生成txt内容（包含两个物品和两个数量）
    text = f"请在{year}年{month}月{date}日{time_idx}将{quantity1}个{item1},{quantity2}个{item2}和{quantity3}个{item3}{action_idx}{loc_idx}"
    texts.append(text)
